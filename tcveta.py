...
lab = Label(fg='black')
e1 = Entry(width=50)
b1 = Button(width=50,bg='#ff0000')
b2 = Button(width=50,bg='#ff7d00')
b3 = Button(width=50,bg='#ffff00')
b4 = Button(width=50,bg='#00ff00')
b5 = Button(width=50,bg='#007dff')
b6 = Button(width=50,bg='#0000ff')
b7 = Button(width=50,bg='#7d00ff')
def red():
    e1.delete(0,END)
    lab['text'] = 'Красный'
